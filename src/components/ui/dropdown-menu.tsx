	...
	return (
		isOpen && (
			<div
				...
				{...props}
				className={twMerge(
					`${position} z-50 mt-0.5 w-full min-w-32 rounded-md border border-border bg-background right-0`,
					'overflow-y-auto transition-all scrollbar-custom',
					isOpen
						? 'data-[state=open]:animate-dropdown-in max-h-72'
